...
import '/pg_solicitacoes_sos/pp_procedimento_recomendado/pp_procedimento_recomendado_widget.dart';
import '/pg_solicitacoes_sos/pp_resolver_sos/pp_resolver_sos_widget.dart';
import 'dart:ui';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';
import 'package:webviewx_plus/webviewx_plus.dart';
import 'pp_detalhe_viagem_sos_model.dart';
export 'pp_detalhe_viagem_sos_model.dart';

class PpDetalheViagemSosWidget extends StatefulWidget {
  const PpDetalheViagemSosWidget({
    super.key,
  ...
  State<PpDetalheViagemSosWidget> createState() =>
      _PpDetalheViagemSosWidgetState();
}

class _PpDetalheViagemSosWidgetState extends State<PpDetalheViagemSosWidget>
    with TickerProviderStateMixin {
  late PpDetalheViagemSosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PpDetalheViagemSosModel());
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (dialogContext) {
                                                return Dialog(
                                                  ...
                                                  child: WebViewAware(
                                                    child:
                                                        PpProcedimentoRecomendadoWidget(
                                                      idSos: widget.idSos!,
                                                      tipoSos: widget.tipoSos!,
                                                    ),
                                                  ),
                                                );
                                              },
