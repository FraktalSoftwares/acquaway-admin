...
import 'pg_viagens_model.dart';
export 'pg_viagens_model.dart';

class PgViagensWidget extends StatefulWidget {
  const PgViagensWidget({super.key});

  @override
  State<PgViagensWidget> createState() => _PgViagensWidgetState();
}

class _PgViagensWidgetState extends State<PgViagensWidget> {
  late PgViagensModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgViagensModel());
                                ...
                                children: [
                                  Text(
                                    valueOrDefault<String>(
                                      '${valueOrDefault<String>(dateTimeFormat("d/M/y", _model.dataInicio, locale: FFLocalizations.of(context).languageCode), '00/00/0000')} - ${valueOrDefault<String>(dateTimeFormat("d/M/y", _model.dataFim, locale: FFLocalizations.of(context).languageCode), '00/00/0000')}',
