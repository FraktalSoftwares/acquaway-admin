              ...
              Column(
                ...
                children: [
                  ...
                  FlutterFlowDropDown<String>(
                    controller: _model.ddNivelValueController ??=
                    ...
                    onChanged: (val) =>
                        safeSetState(() => _model.ddNivelValue = val),
                    width: double.infinity,
                    height: 44.0,
                ...
                children: [
                  ...
                  Builder(
                    builder: (context) => FFButtonWidget(
                      onPressed: () async {
                        // Validações
                        if (_model.txNomeTextController?.text.isEmpty ?? true) {
                        ...
                        final emailError = _model.txEmailTextControllerValidator
                            ?.call(context, _model.txEmailTextController!.text);
                        ...
                        try {
                          ...
                          final authResponse = await SupaFlow.client.auth.signUp(
                            email: _model.txEmailTextController!.text.trim(),
                          ...
                          await UsersTable().insert({
                            'id': userId,
                            'nome': _model.txNomeTextController!.text.trim(),
                            'email': _model.txEmailTextController!.text.trim(),
                            'tipo_user': 'Moderador', // Sempre Moderador conforme solicitado
                            'ativo': true,
                            'verificado': false,
                            'termos': false,
                            'onboard': false,
