                                                                  ...
                                                                  child: Padding(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              valueOrDefault<
                                                                                String
                                                                              >(
                                                                                'Piloto: ${valueOrDefault<String>(SupabaseEdgeGroup.buscarViagensAtivasCall.viagensnomepiloto(gridViewBuscarViagensAtivasResponse.jsonBody)?.elementAtOrNull(listaViagensIndex), 'Nome piloto')}',
                                                                                'Nome piloto',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(
                                                                                context,
                                                                            ...
                                                                            Text(
                                                                              'Origem: ${valueOrDefault<String>(SupabaseEdgeGroup.buscarViagensAtivasCall.viagensorigem(gridViewBuscarViagensAtivasResponse.jsonBody)?.elementAtOrNull(listaViagensIndex), 'Nome origem')}',
                                                                              style: FlutterFlowTheme.of(
                                                                                context,
                                                                              ).bodyMedium.override(
                                                                                font: GoogleFonts.inter(
                                                                            ...
                                                                            Text(
                                                                              'Destino: ${valueOrDefault<String>(SupabaseEdgeGroup.buscarViagensAtivasCall.viagensdestino(gridViewBuscarViagensAtivasResponse.jsonBody)?.elementAtOrNull(listaViagensIndex), 'Nome destino')}',
                                                                              style: FlutterFlowTheme.of(
                                                                                context,
                                                                              ).bodyMedium.override(
                                                                                font: GoogleFonts.inter(
                                                                        ...
                                                                        Text(
                                                                          '${valueOrDefault<String>((SupabaseEdgeGroup.buscarViagensAtivasCall.viagensqtdalertas(gridViewBuscarViagensAtivasResponse.jsonBody)?.elementAtOrNull(listaViagensIndex))?.toString(), '0')} alertas emitidos',
                                                                          style: FlutterFlowTheme.of(
                                                                            context,
                                                                          ).bodyMedium.override(
                                                                            font: GoogleFonts.inter(
